...
write.csv(ampvis_otu, paste0("/srv/MA/Projects/microflora_danica/analysis/projects/MFD_seges/results/WWTP_sequences/kaiju/kaiju_nr/ampvis_otu/",filename,"_nr_ampvisotu.csv"), row.names = FALSE)
