...
write.csv(kraken_otu, paste0("/srv/MA/Projects/microflora_danica/analysis/projects/MFD_seges/results/WWTP_sequences/kraken2/Arc_refseq_WWTP/kraken_ampvis_otu/", filename, "_wwtp_kraken_ampvisotu.csv"), row.names = FALSE)
