...
write.csv(kraken_otu, paste0("/srv/MA/Projects/microflora_danica/analysis/projects/MFD_seges/results/WWTP_sequences/kraken2/bac_refseq_WWTP/kraken_ampvis_otu/", filename, "_bac_refseq_kraken_ampvisotu.csv"), row.names = FALSE)
