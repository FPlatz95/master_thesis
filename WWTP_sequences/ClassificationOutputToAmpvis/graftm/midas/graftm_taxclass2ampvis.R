...
graftm_otu$Kingdom = str_replace(graftm_otu$Kingdom, "k__", "")
graftm_otu$Phylum = str_replace(graftm_otu$Phylum, "p__", "")
graftm_otu$Class = str_replace(graftm_otu$Class, "c__", "")
graftm_otu$Order = str_replace(graftm_otu$Order, "o__", "")
graftm_otu$Family = str_replace(graftm_otu$Family, "f__", "")
graftm_otu$Genus = str_replace(graftm_otu$Genus, "g__", "")
graftm_otu$Species = str_replace(graftm_otu$Species, "s__", "")

write.csv(graftm_otu,paste0("/srv/MA/Projects/microflora_danica/analysis/projects/MFD_seges/results/WWTP_sequences/graftM/01_midas_combined_count/ampvis_otu/", filename, "_midas_graftm.csv"), row.names=F)
