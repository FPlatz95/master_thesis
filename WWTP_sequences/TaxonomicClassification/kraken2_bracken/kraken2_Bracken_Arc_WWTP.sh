...
# run parallel
cat $output_dir1/wwtp_sequences.txt | parallel -j3 kraken2 --db $db_arc_refseq_WWTP --paired $data_path/{}_R1.fastq $data_path/{}_R2.fastq --threads $threads --report $output_dir2/{}_arc_wwtp_kraken2.report '&>' $output_dir1/log/{}_arc_wwtp_kraken2.log

cat $output_dir1/wwtp_sequences.txt | parallel -j3 bracken -d $db_arc_refseq_WWTP -i $output_dir2/{}_arc_wwtp_kraken2.report -o $output_dir2/{}_arc_wwtp_bracken.report '&>' $output_dir1/log/{}_arc_wwtp_bracken2.log
