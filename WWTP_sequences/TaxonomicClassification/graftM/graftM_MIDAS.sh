...
# run parallel
cat $samples_path/wwtp_sequences.txt | parallel -j3 graftM graft --forward $data_path/{} --graftm_package $graftm_package --output_directory $output_dir/{}_MIDAS --threads $threads '&>' $output_dir/log/{}_graftm_MIDAS.log
