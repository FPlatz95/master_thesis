...
corekaiju_filename = gsub("_R1_001", "_corekaiju", filename_grep)
kaiju_file = read.delim(filepath, header = TRUE)
corekaiju_file = read.delim(paste0("/srv/MA/Projects/microflora_danica/analysis/classified_kaiju/core_kaiju/corekaiju2table/", corekaiju_filename), header = TRUE)
...
write.csv(corekaiju_ampvis_otu, paste0("/srv/MA/Projects/microflora_danica/analysis/classified_corekaiju_t20/",filename,"_corekaiju_refseq_t20_ampvisotu.csv"), row.names = FALSE)
