...
write.csv(ampvis_otu, paste0("/srv/MA/Projects/microflora_danica/analysis/classified_kaiju/core_kaiju/corekaiju2table/ampvis_format/",filename,"_ampvisotu.csv"), row.names = FALSE)
