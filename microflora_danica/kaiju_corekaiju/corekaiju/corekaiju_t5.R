...
write.csv(corekaiju_ampvis_otu, paste0("/srv/MA/Projects/microflora_danica/analysis/classified_corekaiju_t5/",filename,"_corekaiju_refseq_t5_ampvisotu.csv"), row.names = FALSE)
