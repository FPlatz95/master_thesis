...
write.csv(kraken_otu, paste0("/srv/MA/Projects/microflora_danica/analysis/classified_kraken2/ampvis_format/", filename, "_gtdb_kraken_ampvisotu.csv"), row.names = FALSE)
